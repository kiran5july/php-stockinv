...
?>
  ...
  <head>
    ...
    <script type="text/javascript" src="includes/pick_fns.js"></script>
    <script type="text/javascript" src="includes/AddFormElement.js"></script>
    <script type="text/javascript" src="includes/fns_form_validations.js"></script>
  </head>
...
function display_site_info($text) {
...
?>
<html><head></head><title>Login</title><body background="images/yell.jpg">
<center><br/><br/>
  ...
  <table bgcolor="#cccccc">
   ...
   <tr>
     <td colspan="2"><a href="forgot_form.php">Forgot password?</a></td>
   </tr>
 </table></form>
...
function display_registration_form() {
	//Moved the code to the new page
?>
 ...
 <table bgcolor="#cccccc">
   ...
   <tr>
     ...
     <td><select name="secretq">
    		...
    		<option value="Use a secret code">Use a secret code</option>
     </select></td></tr>
   <tr>
     <td>Give secret answer:</td>
     <td><input type="text" name="secreta" size="16" maxlength="16"/></td></tr>
   <tr>
   <tr>
     <td colspan=2 align="center">
