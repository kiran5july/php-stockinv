		...
		try{
 			...
 			if (!$result) {
 				...
 				if($rowcount >= 1)
 				{
 					...
 					echo "<table width='95%'><tr><th class='rep'>DATE</th><th class='rep'>PROD NAME</th>
  						<th class='rep'>RETURN WAREHOUSE</th><th class='rep'>QTY</th></tr>";
 					while ($row=mysqli_fetch_row($result))
    				{
    					$dAct = $row[0];
 						...
 						echo "<tr class=\"rep\"><td>".$dAct."</td><td>".$sProdName."
  								</td><td>".$sWHCode."</td><td class=\"rep-num\">".$iQty."</td></tr>";
    				}
